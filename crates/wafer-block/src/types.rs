...
/// Alias for Result_ — preferred name for block authors.
pub type BlockResult = Result_;
...
pub enum BlockRuntime {
    ...
    #[serde(rename = "wasm")]
    Wasm,
    /// Can run either natively or as WASM (pure logic, no OS dependencies).
    #[serde(rename = "both")]
    Both,
}

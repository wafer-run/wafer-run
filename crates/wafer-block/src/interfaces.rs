...
pub fn http_handler_v1() -> InterfaceSpec {
    ...
    actions.insert("retrieve".into(), ActionSpec {
        description: "Handle GET requests.".into(),
        message_schema: None,
        response_schema: None,
    });
    actions.insert("create".into(), ActionSpec {
        description: "Handle POST requests.".into(),
        message_schema: None,
        response_schema: None,
    });
    actions.insert("update".into(), ActionSpec {
        description: "Handle PUT/PATCH requests.".into(),
        message_schema: None,
        response_schema: None,
    });
    actions.insert("delete".into(), ActionSpec {
...
pub fn database_v1() -> InterfaceSpec {
    ...
    actions.insert("database.get".into(), ActionSpec {
    ...
    actions.insert("database.list".into(), ActionSpec {
    ...
    actions.insert("database.create".into(), ActionSpec {
    ...
    actions.insert("database.update".into(), ActionSpec {
    ...
    actions.insert("database.delete".into(), ActionSpec {
    ...
    actions.insert("database.count".into(), ActionSpec {
    ...
    actions.insert("database.query_raw".into(), ActionSpec {
    ...
    actions.insert("database.exec_raw".into(), ActionSpec {
    ...
    actions.insert("database.sum".into(), ActionSpec {
...
pub fn storage_v1() -> InterfaceSpec {
    ...
    actions.insert("storage.put".into(), ActionSpec {
    ...
    actions.insert("storage.get".into(), ActionSpec {
    ...
    actions.insert("storage.delete".into(), ActionSpec {
    ...
    actions.insert("storage.list".into(), ActionSpec {
    ...
    actions.insert("storage.create_folder".into(), ActionSpec {
    ...
    actions.insert("storage.delete_folder".into(), ActionSpec {
    ...
    actions.insert("storage.list_folders".into(), ActionSpec {
...
pub fn crypto_v1() -> InterfaceSpec {
    ...
    actions.insert("crypto.hash".into(), ActionSpec {
    ...
    actions.insert("crypto.compare_hash".into(), ActionSpec {
    ...
    actions.insert("crypto.sign".into(), ActionSpec {
    ...
    actions.insert("crypto.verify".into(), ActionSpec {
    ...
    actions.insert("crypto.random_bytes".into(), ActionSpec {
    ...
    InterfaceSpec {
        name: "crypto@v1".into(),
        description: "Password hashing, JWT signing/verification, and random byte generation.".into(),
        actions,
    }
}
...
pub fn http_client_v1() -> InterfaceSpec {
    ...
    actions.insert("network.do".into(), ActionSpec {
    ...
    InterfaceSpec {
        ...
        description: "Outbound HTTP requests. Provides a single network.do action for making HTTP calls.".into(),
        actions,
    }
}
...
pub fn logger_v1() -> InterfaceSpec {
    ...
    for level in &["debug", "info", "warn", "error"] {
        actions.insert(format!("logger.{}", level), ActionSpec {
